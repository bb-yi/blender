...
assert ddxy > 0.0 and ddx > 0.0 and ddy > 0.0, (
    f"All screen derivative outputs should stay positive for X + Y input, got {ddxy}, {ddx}, {ddy}"
)
assert abs(ddxy - (ddx + ddy)) < 0.002, (
    f"DDXY should stay close to DDX + DDY within render quantization tolerance, got {ddxy}, {ddx}, {ddy}"
)
