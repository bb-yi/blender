...
UNIFORM_BUF(RENDER_TEXTURE_BUF_SLOT, RenderTextureData, render_texture_buf[RENDER_TEXTURE_SLOT_MAX])
SAMPLER(RENDER_TEXTURE_COLOR_TX_SLOT_0, FLOAT_2D, render_texture_color_tx_0)
SAMPLER(RENDER_TEXTURE_COLOR_TX_SLOT_1, FLOAT_2D, render_texture_color_tx_1)
SAMPLER(RENDER_TEXTURE_COLOR_TX_SLOT_2, FLOAT_2D, render_texture_color_tx_2)
SAMPLER(RENDER_TEXTURE_COLOR_TX_SLOT_3, FLOAT_2D, render_texture_color_tx_3)
SAMPLER(RENDER_TEXTURE_HISTORY_TX_SLOT_0, FLOAT_2D, render_texture_color_history_tx_0)
SAMPLER(RENDER_TEXTURE_HISTORY_TX_SLOT_1, FLOAT_2D, render_texture_color_history_tx_1)
SAMPLER(RENDER_TEXTURE_HISTORY_TX_SLOT_2, FLOAT_2D, render_texture_color_history_tx_2)
SAMPLER(RENDER_TEXTURE_HISTORY_TX_SLOT_3, FLOAT_2D, render_texture_color_history_tx_3)
GPU_SHADER_CREATE_END()
