...
GPU_SHADER_CREATE_INFO(eevee_filter_mask_hash_data)
TYPEDEF_SOURCE("eevee_filter_material_shared.hh")
UNIFORM_BUF(FILTER_MASK_HASH_BUF_SLOT, FilterMaskHashData, filter_mask_hash_buf[FILTER_MASK_HASH_MAX])
GPU_SHADER_CREATE_END()
...
ADDITIONAL_INFO(eevee_filter_mask_hash_data)
