...
DEFINE("LIGHT_SHADER_SURFEL_EVAL")
DEFINE_VALUE("LIGHT_CLOSURE_EVAL_COUNT", "1")
LOCAL_GROUP_SIZE(SURFEL_GROUP_SIZE)
ADDITIONAL_INFO(eevee_no_preprocessor)
TYPEDEF_SOURCE("eevee_defines.hh")
TYPEDEF_SOURCE("eevee_lightprobe_shared.hh")
STORAGE_BUF(LIGHT_SHADER_SURFEL_INDEX_BUF_SLOT, read, int, light_shader_index_buf[])
STORAGE_BUF(LIGHT_SHADER_SURFEL_BUF_SLOT, read, float4, light_shader_surfel_buf[])
