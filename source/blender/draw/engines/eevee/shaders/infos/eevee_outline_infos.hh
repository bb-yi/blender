...
GPU_SHADER_CREATE_INFO(eevee_outline_shell_boundary)
DO_STATIC_COMPILATION()
FRAGMENT_OUT(0, float4, out_outline_shell_boundary)
SAMPLER(OUTLINE_SHELL_COLOR_TEX_SLOT, sampler2D, shell_color_tx)
ADDITIONAL_INFO(eevee_fullscreen)
TYPEDEF_SOURCE("eevee_defines.hh")
FRAGMENT_SOURCE("eevee_outline_shell_boundary_frag.glsl")
GPU_SHADER_CREATE_END()
