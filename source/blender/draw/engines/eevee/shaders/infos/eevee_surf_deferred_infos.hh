...
IMAGE_FREQ(OUTLINE_INFO_SLOT, SFLOAT_16_16_16_16, write, image2D, outline_info_img, PASS)
...
GPU_SHADER_CREATE_INFO(eevee_surf_deferred_base_depth_offset)
DEFINE("MAT_DEFERRED")
DEFINE("GBUFFER_WRITE")
DEFINE("MAT_SURFACE_CULL")
TYPEDEF_SOURCE("eevee_render_texture_shared.hh")
...
GPU_SHADER_CREATE_INFO(eevee_surf_deferred_depth_offset)
BUILTINS(BuiltinBits::NO_PREPROCESSOR)
FRAGMENT_SOURCE("eevee_surf_deferred_frag.glsl")
