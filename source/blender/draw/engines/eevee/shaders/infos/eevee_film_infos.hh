...
PUSH_CONSTANT(int, outline_id)
PUSH_CONSTANT(bool, use_outline_in_combined)
PUSH_CONSTANT(bool, has_outline_input)
...
IMAGE(2, SFLOAT_16_16_16_16, write, image2D, combined_output_img)
