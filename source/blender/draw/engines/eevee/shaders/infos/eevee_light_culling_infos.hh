...
STORAGE_BUF(5, read, int, in_light_shader_index_buf[])
STORAGE_BUF(6, write, int, out_light_shader_index_buf[])
STORAGE_BUF(7, read, int, in_volume_light_shader_index_buf[])
STORAGE_BUF(8, write, int, out_volume_light_shader_index_buf[])
STORAGE_BUF(9, read, int, in_surfel_light_shader_index_buf[])
STORAGE_BUF(10, write, int, out_surfel_light_shader_index_buf[])
STORAGE_BUF(11, read, int, in_front_light_shader_index_buf[])
STORAGE_BUF(12, write, int, out_front_light_shader_index_buf[])
