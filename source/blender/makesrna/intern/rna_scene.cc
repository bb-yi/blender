...
#  endif
  ...
  static const std::string& rna_SceneEEVEE_performance_string(const PointerRNA* ptr,
    const SceneEEVEEPerformanceString which)
  {
  ...
  {
    strcpy(value, rna_SceneEEVEE_performance_string(ptr, SceneEEVEEPerformanceString::ViewportSummary).c_str());
  }

  static int rna_SceneEEVEE_performance_profiler_viewport_summary_length(PointerRNA* ptr)
  {
    return rna_SceneEEVEE_performance_string(ptr, SceneEEVEEPerformanceString::ViewportSummary).size();
  }

  static void rna_SceneEEVEE_performance_profiler_viewport_report_get(PointerRNA* ptr, char* value)
  {
    strcpy(value, rna_SceneEEVEE_performance_string(ptr, SceneEEVEEPerformanceString::ViewportReport).c_str());
  }
  ...
  {
    strcpy(value, rna_SceneEEVEE_performance_string(ptr, SceneEEVEEPerformanceString::RenderReport).c_str());
  }
...
#  endif
  ...
  static void rna_Scene_eevee_debug_view_update(Main* bmain, Scene* scene, PointerRNA* ptr)
  {
  ...
  static void rna_Scene_eevee_profiler_view_update(Main* /*bmain*/, Scene* scene, PointerRNA* ptr)
  {
    Scene* owner_scene = id_cast<Scene*>(ptr->owner_id);
    if (owner_scene == nullptr)
    {
...
#  endif
  ...
  static void rna_def_scene_filter_material(BlenderRNA* brna)
  {
    ...
    RNA_def_property_ui_text(prop, "Execution Stage", "Where this filter material runs in Eevee post-processing");
    RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, "rna_SceneEEVEE_render_texture_update");
  ...
  static void rna_def_scene_eevee(BlenderRNA* brna)
  {
    ...
    RNA_def_property_ui_text(
      ...
      "Number of recent frame records used when averaging viewport stage timings");
    RNA_def_property_update(
      prop, NC_SCENE | ND_RENDER_OPTIONS, "rna_Scene_eevee_profiler_view_update");
    ...
    RNA_def_property_clear_flag(prop, PROP_EDITABLE);
    RNA_def_property_ui_text(
      prop, "Render Performance Report", "Latest Eevee final render performance report");
